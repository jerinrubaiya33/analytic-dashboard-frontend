...
//   );
// }
//_________THIS ONE WAS CORRECT_________
...
// export default function LoginPage() {
//   const router = useRouter();
//   const { refetch } = useAuth(false); // do NOT redirect in login page
//   const { register, handleSubmit, formState: { errors } } = useForm<LoginFormInputs>();
//   const [login, { isLoading, error }] = useLoginMutation();
...
//       // Refetch /me query to update auth state
//       await refetch();
...
// // ___________SLEEEEEEEEEPPPP________
// login/page.tsx
// login/page.tsx
"use client";
